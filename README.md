...
After provisioning, I'm able to SSH to the load balancer hostname and then run `psql testdb appuser` without authentication from one of the application VSIs.
